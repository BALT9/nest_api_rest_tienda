...
export class ModifyDateNotasTable1772911983112 implements MigrationInterface {
    name = 'ModifyDateNotasTable1772911983112'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`cliente_proveedor\` CHANGE \`stado\` \`stado\` tinyint NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`cliente_proveedor\` CHANGE \`stado\` \`stado\` tinyint NOT NULL`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX \`IDX_b96326a7b67dcea6caea376982\` ON \`notas\` (\`fecha\`)`);
    }
